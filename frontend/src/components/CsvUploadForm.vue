...
<template>
  <div class="rounded-xl border border-gray-200 bg-white p-4">
    <h2 class="mb-1 text-sm font-semibold text-gray-900">Importer un fichier CSV Basketball-Reference</h2>
    ...
    <p class="mb-3 rounded-lg bg-gray-50 px-3 py-2 text-xs text-gray-600">
    ...
    <input
      ...
      type="file"
      accept=".csv"
      class="mb-3 block w-full text-sm text-gray-700 file:mr-3 file:cursor-pointer file:rounded-lg file:border-0 file:bg-gray-900 file:px-3 file:py-2 file:text-sm file:font-medium file:text-white hover:file:bg-gray-800"
      @change="onFileChange"
    />
